...
io.on("connection", (socket) => {
  ...
  socket.on("driverOffline", () => socket.leave("drivers"));
  ...
  // ── Live chat — broadcast to everyone in the ride room ────────────────────
  socket.on("chatMessage", ({ rideId, message, senderName, senderRole }) => {
